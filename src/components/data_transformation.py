...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_object(
                file_path = self.data_transformation_config.preprocesor_object_file_path,
                obj = preprocessor_object
            )

            logging.info('Saved in pickle file')

            return(
                train_arr,
                test_arr,
                self.data_transformation_config.preprocesor_object_file_path
            )
        except Exception as e:
            raise CustomException(e,sys)